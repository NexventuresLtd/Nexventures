...
export default function Footer({ className = '' }: FooterProps) {
  ...
  const [fontSize] = useState<'normal' | 'large' | 'extra-large'>('normal');
    ...
    >
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#952301] backdrop-blur-sm"
                  required
                ...
                <motion.button
                  ...
                  className="px-6 py-3 bg-[#952301] hover:bg-[#611701] rounded-lg font-semibold flex items-center justify-center gap-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#952301] focus:ring-offset-2 disabled:opacity-50"
                  whileTap={{ scale: 0.95 }}
                >
                  {isSubmitting ? (
                    <motion.div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                {[
                  ...
                  return (
                    ...
                    >
                      <Icon size={20} className="text-[#ffd8cc] mx-auto mb-1" />
            ...
            <motion.div variants={itemVariants}>
              ...
              <ul className="space-y-4 text-gray-300">
                {[
                  { icon: Mail, content: 'info@nexventures.net', href: 'mailto:info@nexventures.net', label: 'Email us' },
                  { icon: Phone, content: '+250 795 022 500', href: 'tel:+250795022500', label: 'Call us' },
                  { icon: Clock, content: 'Mon – Fri, 9AM – 5PM CAT', label: 'Business hours' }
                ].map((contact, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-8 h-8 bg-[#ddb4a7] rounded-lg flex items-center justify-center flex-shrink-0">
                        <Icon size={16} className="text-[#752007]" />
                      </div>
                      {contact.href ? (
                        <a
                          href={contact.href}
                  ...
                  {[
                    ...
                    return (
                      <motion.a
                        ...
                        whileHover="hover" target='_blank'
                      >
      ...
      <motion.button
        ...
        className={`fixed bottom-5 right-24 z-50 w-12 h-12 bg-gradient-to-r from-[#952301] to-[#d87f63] text-white rounded-full flex items-center justify-center transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#952301] focus:ring-offset-2 shadow-lg ${
          showBackToTop ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-24 pointer-events-none'
        }`}
